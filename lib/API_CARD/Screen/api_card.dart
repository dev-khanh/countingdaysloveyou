...
import 'package:countingdaysloveyou/API_CARD/model/itemmodel.dart';
import 'package:countingdaysloveyou/API_CARD/movies_list_bloc.dart';
...
class Api_Card extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SlideShowView(
        onItemInteraction: (movieId) => _navigateToMovieDetail(context, movieId)
      ),
    );
  }
